...
func (x *IsAminReqeust) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAminReqeust) ProtoMessage() {}

func (x *IsAminReqeust) ProtoReflect() protoreflect.Message {
	mi := &file_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAminReqeust.ProtoReflect.Descriptor instead.
func (*IsAminReqeust) Descriptor() ([]byte, []int) {
	return file_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAminReqeust) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_proto_rawDesc = string([]byte{
	...
	0x6b, 0x65, 0x6e, 0x22, 0x28, 0x0a, 0x0d, 0x49, 0x73, 0x41, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x71,
	0x65, 0x75, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0x73, 0x0a, 0x04, 0x41,
...
var file_sso_proto_goTypes = []any{
	...
	(*IsAminReqeust)(nil),    // 4: auth.IsAminReqeust
